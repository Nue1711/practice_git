...
class DropSubKeyView():
    ...
    def __init__(self, user, controller, main):
        ...
        self.__timer = QTimer()
        self.__timer.timeout.connect(self.to_pick_up_key)
    ...
    def retranslateUI(self):
        ...
        self.screen_title.setText(default_string.PLEASE_DROP_SUB_KEY)
    ...
    def to_pick_up_key(self):

        self.__main.onTransferScreen(screen="startScreenPickUpKey")