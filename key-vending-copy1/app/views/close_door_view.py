...
class CloseDoorViewView():
    ...
    def __init__(self, user, controller, main):
        ...
        self.__timer = QTimer()
        self.__timer.timeout.connect(self.to_thank_you)
    ...
    def retranslateUI(self):
        ...
        self.screen_title.setText(default_string.THANK_YOU + default_string.PLEASE_WAIR_SUB_KEY + '\n' + default_string.REG_PLATE+ self.__user.vehicle +'-345\n'+default_string.TAKE_KEY)
